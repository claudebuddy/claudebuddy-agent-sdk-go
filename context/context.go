...
func loadProjectMD(cwd string) string {
	// Check for CLAUDEBUDDY.md and CLAUDE.md in the project root and config dirs
	candidates := []string{
		filepath.Join(cwd, "CLAUDEBUDDY.md"),
		filepath.Join(cwd, "CLAUDE.md"),
		filepath.Join(cwd, ".claudebuddy", "CLAUDEBUDDY.md"),
	...
	if home, err := os.UserHomeDir(); err == nil {
		candidates = append(candidates,
			filepath.Join(home, ".claudebuddy", "CLAUDEBUDDY.md"),
	...
	localPaths := []string{
		...
		filepath.Join(cwd, "CLAUDEBUDDY.local.md"),
	}
	...
	// Load rule files from .claude/rules/ and .claudebuddy/rules/
	ruleDirs := []string{
		filepath.Join(cwd, ".claude", "rules"),
		filepath.Join(cwd, ".claudebuddy", "rules"),
	}
